...
import {
  PerformanceCache,
  AnimationCache
} from '../src/renderer/infrastructure/utils/performance-cache.utils.js';
...
function simulateFrame() {
  ...
  animationCache.set('streaming', true);
...
async function runSimulation() {
  ...
  console.log(`   Animation Cache Active: ${animationCache.activeCount > 0 ? 'Yes' : 'No'}`);

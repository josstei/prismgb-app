...
import { ShaderSelectorComponent } from '@renderer/presentation/features/toolbar/shader-selector.component.js';
import {
  createAppState,
  createEventBus,
  createLogger,
...
vi.mock('@renderer/presentation/features/toolbar/cinematic-toggle.component.js', () => ({
...
vi.mock('@renderer/presentation/features/toolbar/shader-preset-list.component.js', () => ({
...
vi.mock('@renderer/presentation/features/toolbar/shader-slider-controls.component.js', () => ({

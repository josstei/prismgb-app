...
/**
 * Check if WebGPU is the preferred API
 * @param {GPUCapabilities} capabilities
 * @returns {boolean}
 */
export function isWebGPUPreferred(capabilities) {
  return capabilities.preferredAPI === 'webgpu';
}
 ...
 * @returns {boolean}
 */
export function isGPURenderingAvailable(capabilities) {
 ...
 * @returns {boolean}
 */
export function isWorkerRenderingAvailable(capabilities) {

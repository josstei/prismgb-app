...
export class CanvasRenderer {
   ...
   * @param {HTMLVideoElement} videoElement - Video element to render from
   * @param {HTMLCanvasElement} canvasElement - Canvas element to render to
   * @param {Function} isStreamingFn - Function that returns whether streaming is active
   * @param {Function} isHiddenFn - Function that returns whether page is hidden
   */
  ...
  /**
   * Stop rendering
   * @param {HTMLVideoElement} videoElement - Video element used for RVFC cancellation
   */
  ...
  /**
   * Resize canvas dimensions with HiDPI support
   ...
   * @param {number} width - Display width (CSS pixels)
   * @param {number} height - Display height (CSS pixels)
   */

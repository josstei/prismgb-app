import { resolvePreset } from '../application/preset-catalog';
import type { RenderPreset } from '../domain/types';
import { createWorkerPipeline, type WorkerPipeline } from './pipeline';
import {
  WorkerMessageType,
  WorkerResponseType,
...
export function installWorkerRenderer(workerScope: WorkerScopeLike): void {
  ...
  function resolveUniformBrightness(uniforms: FramePayload['uniforms'], preset: RenderPreset): number {

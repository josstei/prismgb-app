...
│   ├── events/     # EventBus
│   ├── streaming/  # Base stream lifecycle, constraints
│   ├── interfaces/ # Core interfaces
│   └── logging/    # Logger factories
├── domains/        # Domain-driven code organization
│   ├── capture/    # Screenshot and recording
│   ├── devices/    # Device detection, adapters, profiles
│   │   ├── adapters/   # Device-specific adapters
│   │   ├── profiles/   # Device configurations
│   │   └── shared/     # DeviceRegistry, helpers
...
│   └── lib/        # Renderer utilities (fileDownload)
├── preload/        # Preload scripts (bridge between processes)
...
```javascript
import { BaseService } from '@/renderer/base/BaseService.js';

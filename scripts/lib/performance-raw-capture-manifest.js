...
const INDEX_SPECS = Object.freeze({
  sentinel: Object.freeze({ schemaVersion: 6, captureCount: PERFORMANCE_PAIR_CARDINALITIES['harness-overhead'] * 2 }),
  externalMetric: Object.freeze({ schemaVersion: 3, captureCount: PAIR_COUNT * 2 }),
  workload: Object.freeze({ schemaVersion: 8, captureCount: PERFORMANCE_PAIR_CARDINALITIES['instrumentation-overhead'] * 2 }),
